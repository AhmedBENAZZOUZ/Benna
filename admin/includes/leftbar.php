...
<nav class="ts-sidebar">
	<ul class="ts-sidebar-menu">
		...
		<li><a href="add_ingredient.php"><i class="fa fa-user"></i> &nbsp;Add ingredient</a>
		</li>
		<li><a href="manage_ingredients.php"><i class="fa fa-download"></i> &nbsp;Manage Ingredients</a>
		</li>
		<li><a href="recipe_suggestion.php"><i class="fa fa-download"></i> &nbsp;Recepie suggestion</a>
		</li>
